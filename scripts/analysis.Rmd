...
#' @param grp_var2 another level of grouping variable - not required and defaults 
#' to none
#' @param ... additional arguments passed onto cont analysis e.g. pctval, cols holding coords
prcnt_meeting <- function(x, grp_var1, ...){
  
  
  cont_analysis(dframe = noxious, subpops = grp_var1, vars = nox_cols, statistics = 'Mean',
